...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">FIX IT JEWELS<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">251,First Floor,Dariba kalan,Chandni Chowk Delhi-110006</div>
    </div>
    ...
    <hr />
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name: INDUSIND BANK NOIDA SEC-51<br/>
            Bank Account no : 159560144201<br/>
            Bank IFSC code : INDB0000276<br/>
            </p>
