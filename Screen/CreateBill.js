...
const CreateBill = () => {
  ...
  const [Product, Set_Product] = useState("GOLD .995");
  ...
  const printToFile = async () => {
    ...
    try{
      ...
      Set_Mobile_No('');
        ...
        Alert.alert("Make shure You have Internet Connection or contact @+91 9560144201");
    }
      ...
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          >
            ...
            <Picker.Item label="GOLD.995" value="G995" />
            <Picker.Item label="GOLD.14KT" value="G14KT" />
            <Picker.Item label="GOLD.18KT" value="G18KT" />
            <Picker.Item label="GOLD.22KT" value="G22KT" />
            <Picker.Item label="LOOSE DIAMOND" value="LD" />
